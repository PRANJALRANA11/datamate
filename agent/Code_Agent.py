...
class CodeAgent:
    ...
    def generate_code(self, prompt,output,init_code=None):
        ...
        if init_code is not None:
            input_prompt = f"""
                    ...
                    * Don't answer the question directly,
                    ...
                    ```python
                    Dataset has been imported with the initial code no need to import it
                    ---> Intial code : {init_code}
            ...
            input_prompt = f"""
                    ...
                    * Don't answer the question directly,
                    ...
                    the code you will use to solve the problem.
                    ```python
                    Imported the dataset with the initial code and store it in df
                    OUTPUT OF PREVIOUS CODE BLOCK : {output}
                    question:{prompt}
                    """
